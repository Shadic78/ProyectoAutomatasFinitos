...
public class VentanaPrincipal {
    ...
    public void setButtons(ControlP5 b) {
        ...
        b.addToggle("addEstadoNormal")
                .setPosition(parent.width - 220, 80)
                .setSize(100, 40)
        ...
        b.addToggle("estadoInicialFinal")
        ...
        b.addToggle("borrarEstado")
                .setPosition(parent.width - 220, 130)
                .setSize(100, 40)
        ...
        b.addToggle("ConexionBucle")
                .setPosition(parent.width - 220, 290)
                .setSize(100, 40)
        ...
        b.addToggle("PasoEjecucion")
                .setPosition(parent.width - 340, 580)
                .setSize(100, 40)
